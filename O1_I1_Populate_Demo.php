...
<html lang="en">
				...
				<div>
					...
					<ul>
						...
						<li>The period under review is the time frame used for making decisions about the case.</li>
                                        ...
                                        <p>A. Name of state and county (or local area): <input type="text" name="FS_A" id="FS_A" size="30" /></p>
						<p>B. Case name: <input type="text" name="FS_B" id="FS_B" size="30" /></p>
						<p>C. Period under review: <input type="text" name="FS_C" id="FS_C" size="30" /></p>
						<p>D. Reviewer name(s): <input type="text" name="FS_D_RN" id="FS_D_RN" size="30" /></p>
						 <p>&nbsp; &nbsp; &nbsp;QA Completed by (name(s)): <input type="text" name="FS_D_QACB" id="FS_D_QACB" size="30" /></p>
						<p>E. Date case reviewed: <input type="text" class="datepicker" name="FS_E" id="FS_E" size="30" /></p>
				</div>
    ...
    <h3>Step3: Question G </h3>
          ...
          <input type="radio" id="FS_G_FC" name="FS_G" class="uniformBtn"  class="radio" value="Foster Care" ><label for="FS_G_FC" style="widht: 30px; margin-right: 100px;">Foster Care</label>
		...
		<h3>Step 5: Question I</h3>
            ...
            <p class="answerStyle">
				<b>Answer to Question I: &nbsp;&nbsp;
                                ...
                                <input type="text" class="datepicker" name="FS_I" id="FS_I" size="30" />
                                <!--
				<input type="text" name="FS_I_MM"  id="FS_I_MM" size="10" />&nbsp;/&nbsp;
                                <input type="text" name="FS_I_DD" id="FS_I_DD" size="10" />&nbsp;/&nbsp;
                                <input type="text" name="FS_I_YYYY" id="FS_I_YY" size="10" />
                                -->
            </p>
		...
		<h3>Step 6: Question J</h3>
          ...
          <p class="answerStyle">
            ...
            -->
            <input type="checkbox" id="FS_J_NA" name="FS_J_NA" class="uniformBtn"  value="NA"><label for="FS_J_NA" style="width: 30px; margin-right: 100px;">NA</label>
         ...
         <div id="CHECK_FS_M1">
            ...
            <!--    <form action="" method="get" name="form4"> -->
                	<table>
                		<tr>
                			<td>
                    <label><input name="FS_M2" type="radio" id="FS_M_PA" value="Physical abuse" />Physical abuse </label>		</td>
                    		<td>
		...
		<!--  <div id="accordion1_1"> -->
			...
			<h3>Step 1: Purpose of Assessment</h3>
				...
				<p>Select the appropriate response below. <b>If the response is "No," complete question A, then rate the case as Not Applicable in the ratings section and continue to item 2. </b></p>
                                      ...
                                      <input type="radio" id="O1_I1_AC_Y" name="O1_I1_AC" class="uniformBtn" class="radio" value="Yes" ><label for="O1_I1_AC_Y" style="margin-right: 100px;">Yes</label>
...
-->              		
              <div style="width: 80%x; overflow: scroll;">
				      ...
				      <table border="2"  name="O1_I1_A1">
					     ...
					     <tr>
						      ...
						      <td><input name="O1_I1_A1_R0_C3" type="text" style="width:97%;"></td>
						      <td>
						      ...
						      <td><input name="O1_I1_A1_R0_C8" type="text" style="width:97%;"></td>
						      <td>
						...
						<td><input name="O1_I1_A1_R1_C3" type="text" style="width:97%;"></td>
						<td>
						...
						<td><input name="O1_I1_A1_R1_C8" type="text" style="width:97%;"></td>
						<td>
					...
					<tr>
						...
						<td><input name="O1_I1_A1_R2_C3" type="text" style="width:97%;"></td>
						<td>
						...
						<td><input name="O1_I1_A1_R2_C8" type="text" style="width:97%;"></td>
						<td>
					...
					<tr>
						...
						<td><input name="O1_I1_A1_R3_C3" type="text" style="width:97%;"></td>
						<td>
						...
						<td><input name="O1_I1_A1_R3_C8" type="text" style="width:97%;"></td>
						<td>
					...
					<tr>
						...
						<td><input name="O1_I1_A1_R4_C3" type="text" style="width:97%;"></td>
						<td>
						...
						<td><input name="O1_I1_A1_R4_C8" type="text" style="width:97%;"></td>
						<td>
					...
					<tr>
						...
						<td><input name="O1_I1_A1_R5_C3" type="text" style="width:97%;"></td>
						<td>
						...
						<td><input name="O1_I1_A1_R5_C8" type="text" style="width:97%;"></td>
						<td>
					...
					<tr>
						...
						<td><input name="O1_I1_A1_R6_C3" type="text" style="width:97%;"></td>
						<td>
						...
						<td><input name="O1_I1_A1_R6_C8" type="text" style="width:97%;"></td>
						<td>
          ...
          <input type="text" id="O1_I1_A1" name="O1_I1_A1" value="" class="textbox" pattern="^\s*$|([0-9\s*$]{1,4})" title="Only numbers allowed, maximum length: 4 digits" ></b>
				</p>
          ...
          <input type="text" id="O1_I1_B" name="O1_I1_B" value="" class="textbox" pattern="^\s*$|([0-9\s*$]{1,4})" title="Only numbers allowed, maximum length: 4 digits" ></b>
				</p>
            ...
            <input type="radio" id="O1_I1_C_Y" name="O1_I1_C" class="uniformBtn" class="radio" value="Yes"   ><label for="O1_I1_C_Y" style="margin-right: 100px;">Yes</label>
...
<!-- BOOTSTRAP try ################################################################################################################  -->
            <p>  Explain the reason for any delays related to reports identified in A and B in the narrative field below.</p>
          <!--
	...
	<p id="I1_Rating">
        ...
        <p>
          <b>Item 1 should be rated as Not Applicable if the response to the question of applicability is No.</b>
            ...
            <input type="radio" id="O1_I1_R_S"  class="uniformBtn" class="radio" value="Strength"  name="O1_I1_R" ><label for="O1_I1_R_S" style="margin-right: 100px;">Strength</label>
...
<!-- ************************************************** ITEM 2    ****************************************************************************************** -->             
    ...
    <div>
      ...
      <div>
        ...
        <p>Select the appropriate response below.<b>If the response is "No," complete question A, then rate the case as Not Applicable in the ratings section and continue to item 3. </b></p>
            ...
            <input type="radio" id="O2_I2_AC_Y" name="O2_I2_AC" class="uniformBtn" class="radio" value="Yes" ><label for="O2_I2_AC_Y" style=" margin-right: 100px;">Yes</label>
    ...
    <!--   <form method="post" id="O2_I2_Q_F"> -->
        ...
        <input type="radio" id="O2_I2_A_Y" name="O2_I2_A" class="uniformBtn" class="radio" value="Yes" ><label for="O2_I2_A_Y" style=" margin-right: 100px;">Yes</label>
    ...
    <div id="CHECK_O2_I2">
        ...
        <input type="radio" id="O2_I2_R_S" name="O2_I2_R" class="uniformBtn" class="radio" value="Strength" ><label for="O2_I2_R_S" style=" margin-right: 100px;">Strength</label>
...
<!-- ************************************************** ITEM 3    ****************************************************************************************** -->                 
                ...
                <div>
                    ...
                    <input type="radio" id="O2_I3_A_Y" name="O2_I3_A" class="uniformBtn" class="radio" value="Yes" ><label for="O2_I3_A_Y" style=" margin-right: 100px;">Yes</label>
                ...
                -->
                    ...
                    <input type="radio" id="O2_I3_B_Y" name="O2_I3_B" class="uniformBtn" class="radio" value="Yes" ><label for="O2_I3_B_Y" style="margin-right: 100px;">Yes</label>
                    ...
                    <input type="radio" id="O2_I3_C_Y" name="O2_I3_C" class="uniformBtn" class="radio" value="Yes" ><label for="O2_I3_C_Y" style="margin-right: 100px;">Yes</label>
        ...
        -->
                    ...
                    <input type="radio" id="O2_I3_D_Y" name="O2_I3_D" class="uniformBtn" class="radio" value="Yes" ><label for="O2_I3_D_Y" style="margin-right: 100px;">Yes</label>
...
question E should be Not Applicable.</li>
                    ...
                    <input type="radio" id="O2_I3_E_Y" name="O2_I3_E" class="uniformBtn" class="radio" value="Yes" ><label for="O2_I3_E_Y" style="margin-right: 100px;">Yes</label>
        ...
        -->
                    ...
                    <input type="radio" id="O2_I3_F_Y" name="O2_I3_F" class="uniformBtn" class="radio" value="Yes" ><label for="O2_I3_F_Y" style="margin-right: 100px;">Yes</label>
                   ...
                   <div id="I3">
                    ...
                    <div id="O2_I3_R_CHECKBOX">
                        ...
                        <input type="radio" id="O2_I3_R_S" name="O2_I3_R" class="uniformBtn" class="radio" value="Strength" ><label for="O2_I3_R_S" style="margin-right: 100px;">Strength</label>
...
-->
                    ...
                    <div>
                     ...
                     <!--   <form method="post" id="O2_R"> -->
                        <input type="radio" id="O2_SA" class="uniformBtn" class="radio" value="Substantially Achieved"  name="O2_R" ><label for="O2_SA" style="widht: 30px; margin-right: 100px;">Substantially Achieved</label>

                        <input type="radio" id="O2_PA"  class="uniformBtn" class="radio" value="Partially Achieved" name="O2_R"><label for="O2_PA" style="widht: 30px;margin-right: 100px;">Partially Achieved</label>

                        <input type="radio" id="O2_NA" class="uniformBtn" class="radio" value="Not Achieved" name="O2_R"><label for="O2_NA" style="widht: 30px;margin-right: 100px;">Not Achieved</label>
      ...
      <div id="accordionT4">  
            ...
            <div id="I4">
                ...
                <div >
                   ...
                   -->
                        ...
                        <p class="answerStyle" id="I4_area"><b>Answer to Question 4A:
                            <input type="text" id="S2_I4_A" name="S2_I4_A" value="" class="textbox" pattern="^\s*$|([0-9\s*$]{1,4})" title="Only numbers allowed, maximum length: 4 digits"></b>
                        </p>
				...
				<caption><b>Placement Table</b></caption>
                                ...
                                <tr>
                                    <td><input name="S2_I4_A1_R0_C0" class="datepicker" type="text" style="width: 97%;"></td>
                                    <td>
                                        <select id="S2_I4_A1_R0_C1" name="S2_I4_A1_R0_C1" style="width:100%;">                   
                                            <option value="" selected="selected"></option>
                                            <option value="Pre-Adoptive Home">Pre-Adoptive Home</option>
                                            <option value="Foster Family Home (Relative)">Foster Family Home (Relative)</option> 
                                            <option value="Foster Family Home (Non-Relative)">Foster Family Home (Non-Relative)</option> 
                                            <option value="Group Home">Group Home</option>
                                            <option value="Institution">Institution</option>
                                            <option value="Supervised Independent Living">Supervised Independent Living</option>
                                        </select>                                    
                                    </td>
                                    <td>
                                        <select id="S2_I4_A1_R0_C2" name="S2_I4_A1_R0_C2" style="width:100%;">                   
                                            <option value="" selected="selected"></option>
                                            <option value="Move to an adoptive or permanent guardian's home">Move to an adoptive or permanent guardian's home</option>
                                            <option value="Move from a more restrictive to a less restrictive placement">Move from a more restrictive to a less restrictive placement</option> 
                                            <option value="Move from a less restrictive to a more restrictive placement">Move from a less restrictive to a more restrictive placement</option> 
                                            <option value="Move to a relative placement">Move to a relative placement</option>
                                            <option value="Move that brings the child closer to family or other important connections">Move that brings the child closer to family or other important connections</option>
                                            <option value="Move to a temporary placement while awaiting a more appropriate placement">Move to a temporary placement while awaiting a more appropriate placement</option>
                                            <option value="Move due to foster parent's request">Move due to foster parent's request</option>
                                            <option value="Other (describe)">Other (describe in the text box below)</option>
                                        </select> 
                                        <input name="S2_I4_A1_R0_C2_OTHER" type="text" style="width: 98%;">
                                    </td>
                                </tr>
                                
                                <tr>
                                    <td><input name="S2_I4_A1_R1_C0" class="datepicker" type="text" style="width: 97%;"></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <input name="S2_I4_A1_R1_C2_OTHER" type="text" style="width: 98%;">
                                    </td>
                                </tr>
                                
                                <tr>
                                    <td><input name="S2_I4_A1_R2_C0" class="datepicker" type="text" style="width: 97%;"></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <input name="S2_I4_A1_R2_C2_OTHER" type="text" style="width: 98%;">
                                    </td>
                                </tr>
                                
                                <tr>
                                    <td><input name="S2_I4_A1_R3_C0" class="datepicker" type="text" style="width: 97%;"></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <input name="S2_I4_A1_R3_C2_OTHER" type="text" style="width: 98%;">
                                    </td>
                                </tr>
                                
                                <tr>
                                    <td><input name="S2_I4_A1_R4_C0" class="datepicker" type="text" style="width: 97%;"></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <input name="S2_I4_A1_R4_C2_OTHER" type="text" style="width: 98%;">
                                    </td>
                                </tr>                                                                
                         </table>
                        ...
                        <input type="radio" id="S2_I4_B_Y" name="S2_I4_B" class="uniformBtn" class="radio" value="Yes"><label for="S2_I4_B_Y" style=" margin-right: 100px;">Yes</label>
                        ...
                        <input type="radio" id="S2_I4_C_Y" name="S2_I4_C" class="uniformBtn" class="radio" value="Yes"><label for="S2_I4_C_Y" style=" margin-right: 100px;">Yes</label>
                        ...
                        <input type="radio" id="S2_I4_R_S" name="S2_I4_R" class="uniformBtn" class="radio" value="Strength"><label for="S2_I4_R_S" style="margin-right: 100px;">Strength</label>
            ...
            <div>
                ...
                <p>
                    ...
                    <input type="radio" id="S2_I5_AC_Y" name="S2_I5_AC" class="uniformBtn" class="radio" value="Yes"><label for="S2_I5_AC_Y" style=" margin-right: 100px;">Yes</label>
                    ...
                    <p>
                        ...
                        <select id="S2_I5_A1_G1" name="S2_I5_A1_G1" style="width:20%;">                   
                            ...
                            <option value="reunification with parents">reunification with parents</option> 
                            <option value="reunification with relatives">reunification with relatives</option>
                            <option value="other planned permanent living arrangements (OPPLA)">other planned permanent living arrangements (OPPLA)</option>
                        </select> 
                        <br><br>
                    ...
                    <input type="radio" id="S2_I5_A2_Y" name="S2_I5_A2" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I5_A2_Y" style=" margin-right: 100px;">Yes</label>
                    ...
                    <input type="radio" id="S2_I5_B_Y" name="S2_I5_B" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I5_B_Y" style=" margin-right: 100px;">Yes</label>
				...
				<caption><b>Permanency Goal Table</b></caption>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="S2_I5_B1_R0_C1" name="S2_I5_B1_R0_C1" class="datepicker" type="text" style="width: 85%;">
                                    </td>
                                    <td><input id="S2_I5_B1_R0_C2"  name="S2_I5_B1_R0_C2" type="text" style="width: 97%;"></td>
                                    <td>
                                        <input id="S2_I5_B1_R0_C3"  name="S2_I5_B1_R0_C3" class="datepicker" type="text" style="width: 85%;">
                                    </td>
                                    <td><input id="S2_I5_B1_R0_C4"  name="S2_I5_B1_R0_C4" type="text" style="width: 97%;"></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input id="S2_I5_B1_R1_C1" name="S2_I5_B1_R1_C1" class="datepicker" type="text" style="width: 85%;">
                                    </td>
                                    <td><input id="S2_I5_B1_R1_C2" name="S2_I5_B1_R1_C2" type="text" style="width: 97%;"></td>
                                    <td>
                                        <input id="S2_I5_B1_R1_C3" name="S2_I5_B1_R1_C3" class="datepicker" type="text" style="width: 85%;">
                                    </td>
                                    <td><input id="S2_I5_B1_R1_C4" name="S2_I5_B1_R1_C4" type="text" style="width: 97%;"></td>
                                </tr>
                                
                                <tr>
                                    <td>
                                        <select id="S2_I5_B1_R2_C0" name="S2_I5_B1_R2_C0" style="width:97%;">                   
                                            <option value="" selected="selected"></option>
                                            <option value="adoption">adoption</option>
                                            <option value="guardianship">guardianship</option> 
                                            <option value="reunification with parents">reunification with parents</option> 
                                    ...
                                    <td>
                                         <input id="S2_I5_B1_R2_C1" name="S2_I5_B1_R2_C1" class="datepicker" type="text" style="width: 85%;">
                                    </td>
                                    <td><input id="S2_I5_B1_R2_C2" name="S2_I5_B1_R2_C2" type="text" style="width: 97%;"></td>
                                    <td>
                                        <input id="S2_I5_B1_R2_C3" name="S2_I5_B1_R2_C3" class="datepicker" type="text" style="width: 85%;">
                                    </td>
                                    <td><input id="S2_I5_B1_R2_C4" name="S2_I5_B1_R2_C4" type="text" style="width: 97%;"></td>
                                </tr>                                                         
                    </table>
                    ...
                    <input type="radio" id="S2_I5_C_Y" name="S2_I5_C" class="uniformBtn" class="radio" value="Yes"><label for="S2_I5_C_Y" style=" margin-right: 100px;">Yes</label>
                    ...
                    <input type="radio" id="S2_I5_D_Y" name="S2_I5_D" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I5_D_Y" style=" margin-right: 100px;">Yes</label>
                    ...
                    <input type="radio" id="S2_I5_E_Y" name="S2_I5_E" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I5_E_Y" style=" margin-right: 100px;">Yes</label>
                    ...
                    <input type="radio" id="S2_I5_F_Y" name="S2_I5_F" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I5_F_Y" style=" margin-right: 100px;">Yes</label>
                    ...
                    <input type="radio" id="S2_I5_G1_1_Y" name="S2_I5_G1_1" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I5_G1_1_Y" style=" margin-right: 100px;">Yes</label>
                    ...
                    <input type="radio" id="S2_I5_G1_2_Y" name="S2_I5_G1_2" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I5_G1_2_Y" style=" margin-right: 100px;">Yes</label>
                    ...
                    <input type="radio" id="S2_I5_G1_3_Y" name="S2_I5_G1_3" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I5_G1_3_Y" style=" margin-right: 100px;">Yes</label>
                    ...
                    <input type="radio" id="S2_I5_G_Y" name="S2_I5_G" class="uniformBtn" class="radio" value="Yes"><label for="S2_I5_G_Y" style=" margin-right: 100px;">Yes</label>
                    ...
                    <input type="radio" id="S2_I5_R_S" name="S2_I5_R" class="uniformBtn" class="radio" value="Strength"><label for="S2_I5_R_S" style="margin-right: 100px;">Strength</label>
            ...
            <div>
                ...
                <p>
                 ...
                 <p class="answerStyle">
                    ...
                    <input type="radio" id="S2_I6_A1_RU" name="S2_I6_A1" class="uniformBtn" class="radio" value="Reunification" ><label for="S2_I6_A1_RU" style="margin-right: 100px;">Reunification</label>
                    ...
                    <br><br>
                    <input type="radio" id="S2_I6_A2_REF" name="S2_I6_A2" class="uniformBtn" class="radio" value="Placement with a non-relative foster parent until age of majority or extended age" ><label for="S2_I6_A2_REF" style=" margin-right: 100px;">Placement with a non-relative foster parent until age of majority or extended age</label>
                    <br><br>
                    ...
                    <br><br>
                    <input type="radio" id="S2_I6_A2_ILP" name="S2_I6_A2" class="uniformBtn" class="radio" value="Placement in an independent living program/supervised independent living until age of majority or extended age"><label for="S2_I6_A2_ILP" style=" margin-right: 100px;">Placement in an independent living program/supervised independent living until age of majority or extended age</label>
                    <br><br>
                    <input type="radio" id="S2_I6_A2_OTHER" name="S2_I6_A2" class="uniformBtn" class="radio" value="Other"><label for="S2_I6_A2_OTHER" style=" margin-right: 100px;">Other (If the child does not have a permanent living arrangement specified, OR if the child has an arrangement that does not fit any of the options above, OR if the goal is noted as "emancipation/independent living" without a permanent placement specified, indicate that below):</label>
                    <br><br>
                    <input type="text" id="S2_I6_A2_OTHER_EXP" name="S2_I6_A2_OTHER_EXP" value="" class="textbox" style="width: 80%;" spellcheck="true"><br>
			...
			<!--
                    ...
                    <p class="answerStyle"><b>Answer to Question 6A4:
                            <input type="text" id="S2_I6_A4" name="S2_I6_A4" value="" class="textbox" pattern="^\s*$|([0-9\s*$]{1,3})" title="Only numbers allowed, maximum length: 3 digits"></b>
                    </p>
                    ...
                    <input type="radio" id="S2_I6_B_Y" name="S2_I6_B" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I6_B_Y" style=" margin-right: 100px;">Yes</label>
                    ...
                    <input type="radio" id="S2_I6_C_Y" name="S2_I6_C" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I6_C_Y" style=" margin-right: 100px;">Yes</label>
                    ...
                    <input type="radio" id="S2_I6_R_S" name="S2_I6_R" class="uniformBtn" class="radio" value="Strength" ><label for="S2_I6_R_S" style="margin-right: 100px;">Strength</label>
            ...
            <div>
                ...
                <div>
                    <p><b>Select the appropriate response:  </b> <input type="button" id="S2_O1_BTN" name="S2_O1_BTN" class="Btn"  value="Click to rate Outcome 1"> <div id="S2_O1_BTN_MSG" style="color:red;"></div></p>
                        ...
                        <input type="radio" id="S2_O1_SA" class="uniformBtn" class="radio" value="Substantially Achieved"  name="S2_O1" ><label for="S2_O1_SA" style="widht: 30px; margin-right: 100px;">Substantially Achieved</label>
 ...
 <div id="tabs-5">
      ...
      <div id="accordionT4">
            ...
            <div>
                ...
                <input type="radio" id="S2_O2_I7_Y" class="uniformBtn" class="radio" value="Yes"  name="S2_O2_I7" ><label for="S2_O2_I7_Y" style="widht: 30px; margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I7_A_Y" name="S2_I7_A" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I7_A_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I7_B_Y" name="S2_I7_B" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I7_B_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <p class="answerStyle">
                        <b>Item 7 Rating (select one):  </b><input type="button" id="I7_BTN" name="I7_BTN" class="Btn"  value="Click to rate Item 7"> <div id="I7_BTN_MSG" style="color:red;"></div>
                </p>
                <input type="radio" id="S2_I7_R_S" name="S2_I7_R" class="uniformBtn" class="radio" value="Strength" ><label for="S2_I7_R_S" style="margin-right: 100px;">Strength</label>
            ...
            <div>
                ...
                <input type="radio" id="S2_I8_AC_Y" name="S2_I8_AC" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I8_AC_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I8_A1_MOW" name="S2_I8_A1" class="uniformBtn" class="radio" value="More than once a week" ><label for="S2_I8_A1_MOW" style=" margin-right: 100px;">More than once a week</label>
                ...
                <input type="radio" id="S2_I8_A1_LOW" name="S2_I8_A1" class="uniformBtn" class="radio" value="Less than once a week, but at least twice a month" ><label for="S2_I8_A1_LOW" style=" margin-right: 100px;">Less than once a week, but at least twice a month</label>
                <br><br>
                ...
                <input type="radio" id="S2_I8_A1_LOM" name="S2_I8_A1" class="uniformBtn" class="radio" value="Less than once a month" ><label for="S2_I8_A1_LOM" style=" margin-right: 100px;">Less than once a month</label>
                ...
                <p>
                 ...
                 <ul>
                    <li>
                       Answer Not Applicable if (1) contact between the child and the mother or father was not in the child's best interests and this was documented in the case file or court order, (2) the whereabouts of the mother or father was not known during the entire period under review, despite documented concerted efforts to locate her, (3) the motherâ€™s or fatherâ€™s parental rights were terminated before the period under review and she/he is not involved in the childâ€™s life, or (4) the mother or father was deceased during the entire period under review.
                    </li>
                    <li>
                ...
                <input type="radio" id="S2_I8_A_Y" name="S2_I8_A" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I8_A_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I8_B1_MOW" name="S2_I8_B1" class="uniformBtn" class="radio" value="More than once a week" ><label for="S2_I8_B1_MOW" style=" margin-right: 100px;">More than once a week</label>
                ...
                <input type="radio" id="S2_I8_B1_LOW" name="S2_I8_B1" class="uniformBtn" class="radio" value="Less than once a week, but at least twice a month" ><label for="S2_I8_B1_LOW" style=" margin-right: 100px;">Less than once a week, but at least twice a month</label>
                <br><br>
                ...
                <input type="radio" id="S2_I8_B1_LOM" name="S2_I8_B1" class="uniformBtn" class="radio" value="Less than once a month"><label for="S2_I8_B1_LOM" style=" margin-right: 100px;">Less than once a month</label>
                ...
                <input type="radio" id="S2_I8_B_Y" name="S2_I8_B" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I8_B_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I8_C_Y" name="S2_I8_C" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I8_C_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I8_D_Y" name="S2_I8_D" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I8_D_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I8_E1_MOW" name="S2_I8_E1" class="uniformBtn" class="radio" value="More than once a week" ><label for="S2_I8_E1_MOW" style=" margin-right: 100px;">More than once a week</label>
                ...
                <input type="radio" id="S2_I8_E1_LOW" name="S2_I8_E1" class="uniformBtn" class="radio" value="Less than once a week, but at least twice a month" ><label for="S2_I8_E1_LOW" style=" margin-right: 100px;">Less than once a week, but at least twice a month</label>
                <br><br>
                ...
                <input type="radio" id="S2_I8_E1_LOM" name="S2_I8_E1" class="uniformBtn" class="radio" value="Less than once a month" ><label for="S2_I8_E1_LOM" style=" margin-right: 100px;">Less than once a month</label>
                ...
                <input type="radio" id="S2_I8_E_Y" name="S2_I8_E" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I8_E_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I8_F_Y" name="S2_I8_F" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I8_F_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I8_R_S" name="S2_I8_R" class="uniformBtn" class="radio" value="Strength" ><label for="S2_I8_R_S" style="margin-right: 100px;">Strength</label>
            ...
            <div>
                ...
                <input type="radio" id="S2_I9_AC_Y" name="S2_I9_AC" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I9_AC_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I9_A_Y" name="S2_I9_A" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I9_A_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I9_B_Y" name="S2_I9_B" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I9_B_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I9_C_Y" name="S2_I9_C" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I9_C_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I9_D_Y" name="S2_I9_D" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I9_D_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I9_R_S" name="S2_I9_R" class="uniformBtn" class="radio" value="Strength" ><label for="S2_I9_R_S" style="margin-right: 100px;">Strength</label>
            ...
            <div>
                ...
                <input type="radio" id="S2_I10_AC_Y" name="S2_I10_AC" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I10_AC_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I10_A1_Y" name="S2_I10_A1" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I10_A1_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I10_A2_Y" name="S2_I10_A2" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I10_A2_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I10_B_Y" name="S2_I10_B" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I10_B_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I10_B_SP_ID" name="S2_I10_B_SP" class="uniformBtn" class="radio" value="Identify" ><label for="S2_I10_B_SP_ID" style=" margin-right: 100px;">Identify</label>
                ...
                <input type="radio" id="S2_I10_C_Y" name="S2_I10_C" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I10_C_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I10_R_S" name="S2_I10_R" class="uniformBtn" class="radio" value="Strength" ><label for="S2_I10_R_S" style="margin-right: 100px;">Strength</label>
            ...
            <div>
                ...
                <input type="radio" id="S2_I11_AC_Y" name="S2_I11_AC" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I11_AC_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <input type="radio" id="S2_I11_A_Y" name="S2_I11_A" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I11_A_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <p>
                    <input type="checkbox" id="S2_I11_A1_M0" name="S2_I11_A1[]" value="NA">NA<br>
                    <input type="checkbox" id="S2_I11_A1_M1" name="S2_I11_A1[]" value="None">None<br>
                    <input type="checkbox" id="S2_I11_A1_M2" name="S2_I11_A1[]" value="Encouraged the mother's participation in school activities and case conferences, attendance at doctors' appointments with the child, or engagement in the child's after school or sports activities?">Encouraged the mother's participation in school activities and case conferences, attendance at doctors' appointments with the child, or engagement in the child's after school or sports activities?<br>
                    <input type="checkbox" id="S2_I11_A1_M3" name="S2_I11_A1[]" value="Provided or arranged for transportation or provided funds for transportation so that the mother could attend the child's special activities and doctors' appointments?">Provided or arranged for transportation or provided funds for transportation so that the mother could attend the child's special activities and doctors' appointments?<br>
                    <input type="checkbox" id="S2_I11_A1_M4" name="S2_I11_A1[]" value="Provided opportunities for therapeutic situations to help the mother and child strengthen their relationship?">Provided opportunities for therapeutic situations to help the mother and child strengthen their relationship?<br>
                    <input type="checkbox" id="S2_I11_A1_M5" name="S2_I11_A1[]" value="Encouraged the foster parents to provide mentoring or serve as role models to the mother to assist her in appropriate parenting?">Encouraged the foster parents to provide mentoring or serve as role models to the mother to assist her in appropriate parenting?<br>
                    <input type="checkbox" id="S2_I11_A1_M6" name="S2_I11_A1[]" value="Encouraged and facilitated contact with the incarcerated mother (where appropriate) or with the mother not living in close proximity to the child?">Encouraged and facilitated contact with the incarcerated mother (where appropriate) or with the mother not living in close proximity to the child?<br>
                </p>
                ...
                <input type="radio" id="S2_I11_B_Y" name="S2_I11_B" class="uniformBtn" class="radio" value="Yes" ><label for="S2_I11_B_Y" style=" margin-right: 100px;">Yes</label>
                ...
                <p>
                    <input type="checkbox" id="S2_I11_B1_F0" name="S2_I11_B1[]" value="NA">NA<br>
                    <input type="checkbox" id="S2_I11_B1_F1" name="S2_I11_B1[]" value="None">None<br>
                    <input type="checkbox" id="S2_I11_B1_F2" name="S2_I11_B1[]" value="Encouraged the father's participation in school activities and case conferences, attendance at doctors' appointments with the child, or engagement in the child's after school or sports activities?">Encouraged the father's participation in school activities and case conferences, attendance at doctors' appointments with the child, or engagement in the child's after school or sports activities?<br>
                    <input type="checkbox" id="S2_I11_B1_F3" name="S2_I11_B1[]" value="Provided or arranged for transportation or provide funds for transportation so that the father could attend the child's special activities and doctors' appointments?">Provided or arranged for transportation or provide funds for transportation so that the father could attend the child's special activities and doctors' appointments?<br>
                    <input type="checkbox" id="S2_I11_B1_F4" name="S2_I11_B1[]" value="Provided opportunities for therapeutic situations to help the father and child strengthen their relationship?">Provided opportunities for therapeutic situations to help the father and child strengthen their relationship?<br>
                    <input type="checkbox" id="S2_I11_B1_F5" name="S2_I11_B1[]" value="Encouraged the foster parents to provide mentoring or serve as role models to the father to assist him in appropriate parenting?">Encouraged the foster parents to provide mentoring or serve as role models to the father to assist him in appropriate parenting?<br>
                    <input type="checkbox" id="S2_I11_B1_F6" name="S2_I11_B1[]" value="Encouraged and facilitated contact with the incarcerated father (where appropriate) or with the father not living in close proximity to the child?">Encouraged and facilitated contact with the incarcerated father (where appropriate) or with the father not living in close proximity to the child?<br>
                </p>
                ...
                <input type="radio" id="S2_I11_R_S" name="S2_I11_R" class="uniformBtn" class="radio" value="Strength" ><label for="S2_I11_R_S" style="margin-right: 100px;">Strength</label>
                ...
                <p>
                    <input type="checkbox" id="S2_I11_R_SRC_CF" name="S2_I11_R_SRC[]" value="case file">case file<br>
                    <input type="checkbox" id="S2_I11_R_SRC_MI" name="S2_I11_R_SRC[]" value="mother interview">mother interview<br>
                    <input type="checkbox" id="S2_I11_R_SRC_FI" name="S2_I11_R_SRC[]" value="father interview">father interview<br>
                    <input type="checkbox" id="S2_I11_R_SRC_FPI" name="S2_I11_R_SRC[]" value="foster parent interview">foster parent interview<br>
                    <input type="checkbox" id="S2_I11_R_SRC_CI" name="S2_I11_R_SRC[]" value="child interview">child interview<br>
                    <input type="checkbox" id="S2_I11_R_SRC_CWI" name="S2_I11_R_SRC[]" value="caseworker/supervisor interview">caseworker/supervisor interview<br>
                    <input type="checkbox" id="S2_I11_R_SRC_OI" name="S2_I11_R_SRC[]" value="other interview">other interview<br>
                </p>
            ...
            <div>
                ...
                <div>
                    <p><b>Select the appropriate response:  </b><input type="button" id="S2_O2_BTN" name="S2_O2_BTN" class="Btn"  value="Click to rate Outcome 2"> <div id="S2_O2_BTN_MSG" style="color:red;"></div></p>
                        ...
                        <input type="radio" id="S2_O2_SA" class="uniformBtn" class="radio" value="Substantially Achieved"  name="S2_O2" ><label for="S2_O2_SA" style="widht: 30px; margin-right: 100px;">Substantially Achieved</label>
